...
def fill_in_err_table(err_columns_list:list, header_errors:list):
...
def fill_in_table():
    ...
    header_errors_list = header_checker(global_vars.sample_columns, list(global_vars.horizontal_headers))
